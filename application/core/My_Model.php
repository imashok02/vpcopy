  ...
  */
	...
	*/
	...
	function get_all_categories() {
	  	...
	  	$sql = "SELECT * FROM `bs_categories` ORDER BY cat_name asc";
	...
	function get_all_categories1() {

	  	$sql = "SELECT * FROM `bs_categories` ORDER BY cat_name desc";
	...
	function get_all_subcategories() {
	  	...
	  	$sql = "SELECT * FROM `bs_subcategories` ORDER BY name asc";
	...
	function get_all_subcategories1() {

	  	$sql = "SELECT * FROM `bs_subcategories` ORDER BY name desc";

	...
	<div class="col-md-6">
		<div class="card card-info">
		    <div class="card-header">
		        <h3 class="card-title"><?php echo get_msg('condition_info')?></h3>
		    </div>
	        <!-- /.card-header -->
	        <div class="card-body">
	            <div class="row">
            		...
            		<div class="form-group">
								...
								<?php
									...
									echo form_dropdown(
										'main_cat_id',
										$options,
										set_value( 'main_cat_id', show_data( @$condition->main_cat_id), false ),
	            	...
	            	<div class="col-md-12">
	            		<div class="form-group">
	                   		<label>
								...
								<?php echo get_msg('condition_name')?>
							...
							<?php echo form_input( array(
								'name' => 'name',
								'value' => set_value( 'name', show_data( @$condition->name ), false ),
								'class' => 'form-control form-control-sm',
								'placeholder' => get_msg( 'condition_name' ),
								'id' => 'name'
							)); ?>
	              		</div>
	              	</div>

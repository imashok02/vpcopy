...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_purchase_label' ),
		'message' =>  get_msg( 'purchase_yes_all_message' ),
		'yes_all_btn' => get_msg( 'purchase_yes_all_label' ),
		'no_only_btn' => get_msg( 'purchase_no_only_label' )
	);

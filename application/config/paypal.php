 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'teamps.dev-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '7QQ7AJBGLK9Z9QMZ' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AbfC8zBrnI2pcur24wALbfz5k73VA-S0qXL7mJrjqXasSvz6-.UrLS7q' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'teamps.dev@gmail.com';
